<?php
	if(isset($_POST["submit"])){
		...
		if($result){
			...
			$body .= "<h1>You've been added to our database. </h1><br>";
			...
			if($_POST["accType"] == "Manager"){
				...
				$body .= "<strong>Account Type: </strong>Participant<br><br><br>";
			}
		} else{
		...
		<form action="main.php" method="post">
		    <input type="submit" name="submit" value="Return to main menu" class="btn btn-primary active"/>
		</form>
		</div>
EOBODY;

		if($_POST["accType"] == "Manager"){
			$page = generatePage($body.$button, "<br><h4>Application Submitted</h4>");
		} else{
			$page = generatePage($body.$button, "<br><h4>Application Submitted</h4>");
		}
